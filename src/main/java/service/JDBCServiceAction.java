...
public class JDBCServiceAction {
    ...
    public int addAction(Action action, int idToUser) {
        ...
        try {
            ...
            try (PreparedStatement statementAction = connection.prepareStatement(propertyInf.getDataFromProperties(StateProperties.SQL).getProperty("ADD_ACTION"), PreparedStatement.RETURN_GENERATED_KEYS)) {
                ...
                if (action.getTypeAction().equals(TypeAction.EVENT) && idToUser > 0) {
                    ...
                    try (PreparedStatement statementInvite = connection.prepareStatement(propertyInf.getDataFromProperties(StateProperties.SQL).getProperty("ADD_INVITE_USERS"))) {
    ...
    public List<Action> getAllActionForUser(String email) {
        ...
        try (Connection connection = DBConnection.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement(propertyInf.getDataFromProperties(StateProperties.SQL).getProperty("GET_FULL_ACTION"))) {
    ...
    public List<Action> getAllActionUserForManager() {
        ...
        try (Connection connection = DBConnection.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement(propertyInf.getDataFromProperties(StateProperties.SQL).getProperty("GET_FULL_ACTION_MANAGER"))) {
                try (ResultSet result = statement.executeQuery()) {
                    while (result.next()) {
                        list.add(getInfAction(result));
                    }
    ...
    public List<Action> getAllActionInvite(String inviteUsersEmail) {
        ...
        try (Connection connection = DBConnection.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement(propertyInf.getDataFromProperties(StateProperties.SQL).getProperty("GET_INVITE_USERS"))) {
    ...
    public Action getActionById(int id) {
        ...
        try (Connection connection = DBConnection.getConnection()) {
            ...
            try (PreparedStatement statement = connection.prepareStatement(propertyInf.getDataFromProperties(StateProperties.SQL).getProperty("GET_ACTION_BY_ID"))) {
    ...
    public boolean deletedInvite(int id) {
        try (Connection connection = DBConnection.getConnection()) {
            ...
            try (PreparedStatement statement = connection.prepareStatement(propertyInf.getDataFromProperties(StateProperties.SQL).getProperty("DELETE_INVITE_BY_ID"))) {
                statement.setInt(1, id);
    ...
    public int[] getDataFromInvited(int id) {
        ...
        try (Connection connection = DBConnection.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement(new PropertyInf().getDataFromProperties(StateProperties.SQL).getProperty("GET_ID_ACTION_FROM_INVITED"))) {
                statement.setInt(1, id);
                try (ResultSet resultSet = statement.executeQuery()) {
    ...
    public void changeAcceptedEvent(int id) {
        try (Connection connection = DBConnection.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement(propertyInf.getDataFromProperties(StateProperties.SQL).getProperty("ADD_ACCEPTED_EVENT"))) {
                statement.setInt(1, id);
    ...
    public List<Action> actionBetweenDate(String start, String end) {
        ...
        try (Connection connection = DBConnection.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement(propertyInf.getDataFromProperties(StateProperties.SQL).getProperty("GET_ACTION_BETWEEN"))) {
    ...
    public int countAcceptedEventBetweenDate(String start, String end) {
        int k = 0;
        try (Connection connection = DBConnection.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement(propertyInf.getDataFromProperties(StateProperties.SQL).getProperty("GET_COUNT_ACCEPTED_MONTH"))) {
                statement.setString(1, start);
                statement.setString(2, end);
                try (ResultSet result = statement.executeQuery()) {
                    while (result.next()) {
