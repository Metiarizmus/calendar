...
public class HelperGetFullDate {
    ...
    public String[] getNowDateAndPlusMonth() {
        ...
        Calendar calendar1 = new GregorianCalendar();
        calendar1.set(Integer.parseInt(todaydate[0]),Integer.parseInt(todaydate[1])-2,Integer.parseInt(todaydate[2]));
    ...
    public static void main(String[] args) {
        System.out.println(new HelperGetFullDate().getNowDateAndPlusMonth()[1]);
        System.out.println(new HelperGetFullDate().getNowDateAndPlusMonth()[0]);
