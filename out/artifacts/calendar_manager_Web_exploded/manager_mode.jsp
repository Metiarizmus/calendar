...
<div class="content">
    ...
    <div class="sidenav">
        ...
        <form id="formInfoUsers" action="actionUsersManager" method="post">
            <p class="infoUsers" onclick="document.getElementById('formInfoUsers').submit(); return false;">Действия пользователей</p>
        </form>

        <form id="formUsersStatistics" action="managerCharts" method="post">
            <p class="infoUsers" onclick="document.getElementById('formUsersStatistics').submit(); return false;">Статистика пользователей</p>
        </form>
