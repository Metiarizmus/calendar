...
<div class="content">
    ...
    <div class="sidenav">
        ...
        <form id="formInfoUsers" action="actionUsersAdmin" method="post">
            <p class="infoUsers" onclick="document.getElementById('formInfoUsers').submit(); return false;">Действия пользователей</p>
        </form>

        <form id="formUsersForAdmin" action="listUsersAdmin" method="post">
            <p class="infoUsers" onclick="document.getElementById('formUsersForAdmin').submit(); return false;">Пользователи</p>
        </form>
